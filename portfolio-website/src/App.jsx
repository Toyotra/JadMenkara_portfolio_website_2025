  ...
  return (
    ...
    <div className="app-container">
        ...
        <div className="flex justify-center">
          <h1 class="font-bold text-[30px] text-black text-center">J@D MENKAR@'s G0DTIεR PORTFOLI0 W3B51T3</h1>
        ...
        <div class="flex justify-center mb-2" >
          <div id="TheyAreSoCooked">
            <div class="flex justify-center">
              ...
              class="w-50 border-4 border-black hover:w-80 transition-all duration-1500"
